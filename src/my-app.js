...
class MyApp extends PolymerElement {
    ...
    #contentContainer{
      ...
      <app-drawer-layout fullbleed="" narrow="{{narrow}}" style="background-color:#f1f1f1!important">
        ...
        <app-toolbar><img src="/images/ing-logo-vector.png"  height="200%"></app-toolbar>
          ...
          <a name="login" href="[[rootPath]]login">Login</a><!--Login-->        
        </iron-selector>
        </app-drawer>
  ...
  constructor() {
    super();
    localStorage.isDashboard = false; 
  ...
  static get properties() {
    return {
      ...
      isDashboardFlag:{//localStorage.isDashboard = false; localStorage.isLogin = false;
        type:Boolean,
        value:localStorage.isDashboard
      },
      isLoginFlag:{
        type:Boolean,
        value:localStorage.isLogin
      }
     ,
      routeData: Object,
      subroute: Object
